...
public class CoopPlayerLevelSelectionMenu extends LevelSelectionMenu {
    ...
    public void create() {
        ...
        int maxLevel = CoopDataHandler.getPlayerMaxLevel(playerName);
        double totalScore = CoopDataHandler.getPlayerTotalScore(playerName);
        double lvl1 = CoopDataHandler.getPlayerScoreForLevel(playerName, 1);
        double lvl2 = CoopDataHandler.getPlayerScoreForLevel(playerName, 2);
        double lvl3 = CoopDataHandler.getPlayerScoreForLevel(playerName, 3);
        double lvl4 = CoopDataHandler.getPlayerScoreForLevel(playerName, 4);
        double lvl5 = CoopDataHandler.getPlayerScoreForLevel(playerName, 5);
